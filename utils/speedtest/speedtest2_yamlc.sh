...
wget -O clash_config.yml https://github.com/qjlxg/configs/raw/refs/heads/master/utils/speedtest/clash_config_eu.yml
wget -O proxychains.conf https://github.com/qjlxg/configs/raw/refs/heads/master/utils/speedtest/proxychains.conf
wget -O lite_config.json https://github.com/qjlxg/configs/raw/refs/heads/master/utils/speedtest/lite_config_yaml.json
#初始化 Clash
chmod +x ./clash && ./clash &
#安装并配置 proxychains
...
sudo nohup proxychains ./lite-linux-amd64 --config ./lite_config.json --test https://github.com/qjlxg/configs/raw/refs/heads/master/sub/sub_merge_yaml.yml > speedtest.log 2>&1 &
